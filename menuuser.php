...
<div id="modal2" class="modal">
    <div class="modal-content">
        ...
        <thead>
          <tr>
              <th data-field="id_kredit" rowspan="2">Id Book</th>
              <th data-field="id_product" rowspan="2">Tanggal</th>
              <th data-field="uang_muka" rowspan="2">Username</th>
              <th data-field="angsuran" colspan="3">Nopol</th>
          </tr>
            <tr>
                <th>11x</th>
                <th>25x</th>
        ...
        <tbody>
            <?php
                ...
                $sql = "SELECT * FROM booking order by id_book";
